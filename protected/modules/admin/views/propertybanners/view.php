...
$this->menu = array(
    array('label'=> $this->pluralTitle, 'url'=>array('index','property_id'=>$model->property_id), 'icon' => $this->iconList),	
    array('label'=> 'Update '. $this->singleTitle, 'url'=>array('update', 'id'=>$model->id)),
	array('label' => 'Create ' . $this->singleTitle, 'url' => array('create','property_id'=>$model->property_id)),
);   
