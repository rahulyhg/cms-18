    ...
    <div class="panel-body">
        ...
        <div class="col-sm-4">
            <div class="form-group form-group-sm">
                ...
                <div class="col-sm-7">
                    <?php echo $form->dropDownList($model, 'seen', $model->optionYesNo, array('empty' => 'All', 'class' => 'form-control')); ?>
        ...
        <div class="col-sm-4">
            <div class="form-group form-group-sm">
                ...
                <div class="col-sm-7">
                    <?php echo $form->dropDownList($model, 'dispense', $model->optionYesNo, array('empty' => 'All', 'class' => 'form-control')); ?>
        ...
        <div class="col-sm-4">
            <div class="form-group form-group-sm">
                ...
                <div class="col-sm-7">
                    ...
                    echo $form->dropDownList($model, 'doctor_id', $doctorList, array('empty' => 'All', 'class' => 'form-control')); ?>
