...
?><div class="panel panel-default">
	...
	array(
                'name' => "min_bedroom",
                'value' => ($model->min_bedroom && $model->max_bedroom)?$model->min_bedroom . " - " . $model->max_bedroom:"",
                'htmlOptions' => array('style' => 'text-align:right;'),
              ),
	'budget',
            ...
            array(
                    'name' => 'tenure_id',
                    'value' => isset($model->tenures->name)?$model->tenures->name:"",
                    'htmlOptions' => array('style' => 'text-align:right;'),
                    'type' => 'raw',
                ),
	array(
                    'name' => 'ready',
                    'value' => ($model->ready==1)?"Ready":"BUC",
                    'htmlOptions' => array('style' => 'text-align:right;'),
                    'type' => 'raw',
                ),
	array(
