...
$('#clearsearch').click(function(){
	...
	$.fn.yiiGridView.update('product-grid', {data: data});
	return false;
});
...
if (in_array("Delete", $this->listActionsCanAccess)) {
    $columnArray[] = array(
		...
		$columnArray = array_merge($columnArray, array(
			...
			array(
				'name' => 'category_id',
				'value' => 'isset($data->Category->category_name)?$data->Category->category_name:""',
			...
			array(
				...
				'htmlOptions' => array('style' => 'text-align:center;')
                        ...
                        array(
                            ...
                            'urlExpression'=>'Yii::app()->createUrl("admin/productsimg/index",array("id"=>$data->id))',
                            'header'=>'Photos'
                        ),
			array(
				'header' => 'Actions',
