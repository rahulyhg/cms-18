<div class="panel panel-default">
	...
	<div class="panel-body">
		<div class="form">
            ...
            <div class='form-group form-group-sm'>
                <?php echo $form->labelEx($model, 'youtubeurl', array('class' => 'col-sm-1 control-label')); ?>
                <div class="col-sm-6">
                    <?php echo $form->textField($model, 'youtubeurl', array('class' => 'form-control', 'maxlength' => 50)); ?>
			...
			<?php echo CHtml::htmlButton('<span class="' . $this->iconCancel . '"></span> Cancel', array('class' => 'btn btn-default', 'onclick' => 'javascript: location.href=\'' . $this->baseControllerIndexUrl('') . '/videos\'')); ?>
			</div>
<?php $this->endWidget(); ?>
		</div>
	</div>
