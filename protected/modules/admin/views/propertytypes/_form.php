    ...
    <div class="panel-body">
        <div class="form">
            ...
            <div class='form-group form-group-sm'>
                <?php echo $form->labelEx($model, 'property_type', array('class' => 'col-sm-1 control-label')); ?>
                <div class="col-sm-3">
                    <?php echo $form->textField($model, 'property_type', array('class' => 'form-control', 'maxlength' => 255)); ?>
