            ...
            <div class="col-md-4">
                ...
                <div class="col-md-12 form-group form-group-sm">
                    ...
                    <div class="col-md-8">
                        <div class="row phonenumber">
                            <div class="col-md-3">
                                <?php echo $form->textField($model,'residential_block_house',array('size'=>47,'maxlength'=>255, 'class' => 'form-control numeric-control')); ?>
                            </div>
                ...
                <div class="col-md-12 form-group form-group-sm">
                    ...
                    <div class="col-md-8">
                        <div class="row">
                            <div class="col-md-5">
                                <?php echo $form->textField($model,'residential_postal_code',array('size'=>47,'maxlength'=>255, 'class' => 'form-control postal-code')); ?>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 form-group form-group-sm">
                        ...
                        <div class="col-md-8">
                            <div class="row">
                                <div class="col-md-5">
                                    <?php echo $form->textField($model,'mailling_postal_code',array('size'=>47,'maxlength'=>255, 'class' => 'form-control postal-code')); ?>
                                </div>
                    ...
                    <div class="col-md-12 form-group form-group-sm">
                        ...
                        <div class="col-md-10">
                            <div class="row phonenumber">
                                ...
                                <div class="col-md-3">
                                    <?php echo $form->textField($model,'contact_number_2',array('size'=>47,'maxlength'=>255, 'class' => 'form-control')); ?>
                                </div>
                            </div>
                            <div class="col-md-12 nopadding">
                    ...
                    <div class="col-md-12 form-group form-group-sm">
                        ...
                        <div class="col-md-10">
                            <div class="row phonenumber">
                                ...
                                <div class="col-md-3">
                                    <?php echo $form->textField($model,'contact_number_3',array('size'=>47,'maxlength'=>255, 'class' => 'form-control')); ?>
                                </div>
                            </div>
                            <div class="col-md-12 nopadding">
...
<script type="text/javascript">
    ...
    function processPostalName(postalNameDiv, postalNameId, zipcode, type){
        ...
        $.post("http://maps.googleapis.com/maps/api/geocode/json?address="+zipcode+"&sensor=false", function (response){
