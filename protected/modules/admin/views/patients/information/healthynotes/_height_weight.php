...
<div class="panel panel-default">
    <div class="panel-heading">
        ...
        <?php echo CHtml::link(Yii::t('static', '<span class="glyphicon glyphicon-print"></span> Print Table'), array('mpdfprint/index', 'patient_id'=>$patient_id, 'type' => 'heightweight'), array('class' => 'btn-1 pull-right', 'target'=>'_blank')); ?>
