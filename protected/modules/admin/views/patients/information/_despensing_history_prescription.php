...
<?php 
    $dispensingPrintUrl = Yii::app()->createAbsoluteUrl('mpdfprint/index', array('patient_id'=>$patient_id, 'type' => 'dispensinghistory'));
    $prescriptionPrintUrl = Yii::app()->createAbsoluteUrl('mpdfprint/index', array('patient_id'=>$patient_id, 'type' => 'prescription'));
?>
<div class="panel panel-default">
    <div class="panel-heading">
        ...
        <?php echo CHtml::link(Yii::t('static', '<span class="glyphicon glyphicon-print"></span> Print'), $dispensingPrintUrl, array('class' => 'btn-1 pull-right', 'target'=>'_blank')); ?>    
    </div>
...
<div class="panel panel-default">
    <div class="panel-heading">
        ...
        <?php echo CHtml::link(Yii::t('static', '<span class="glyphicon glyphicon-print"></span> Print Table'), $prescriptionPrintUrl, array('class' => 'btn-1 pull-right', 'target'=>'_blank')); ?>
