...
{
    public $pluralTitle = 'Religion';
    public $singleTitle = 'Religion';
    public $cannotDelete = array();
    public function actionCreate(){
        try {
            $model = new Religion('create');
	...
	*/
	...
	{
		$deleteItems = $_POST['religion-grid_c0'];
		$shouldDelete = array_diff($deleteItems, $this->cannotDelete);

		if (!empty($shouldDelete))
		{
						Religion::model()->deleteAll('id in (' . implode(',', $shouldDelete) . ')');
