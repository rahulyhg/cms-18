...
class SubscriberController extends AdminController
{
    ...
    public function actionCreate(){
        try {
            ...
            if (isset($_POST['Subscriber'])) {
                ...
                if($model->validate()){
                    $model->subscriber_group_id =json_encode($model->subscriber_group_id);
                    if($model->save())
                    {
    ...
    public function actionUpdate($id) {
        ...
        if(isset($_POST['Subscriber']))
        {
            ...
            if($model->subscriber_group_id !=''){
                $model->subscriber_group_id =json_decode($model->subscriber_group_id,true);
            }
        }
        //$model->beforeRender();
    ...
    */
    ...
    public function actionRemoveImportFile() {
