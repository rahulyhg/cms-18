...
{
    public $pluralTitle = 'District';
    public $singleTitle = 'District';
	...
	*/
	...
	{
		$deleteItems = $_POST['district-grid_c0'];
		$shouldDelete = array_diff($deleteItems, $this->cannotDetele);

		if (!empty($shouldDelete))
		{
						District::model()->deleteAll('id in (' . implode(',', $shouldDelete) . ')');
