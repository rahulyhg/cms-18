...
<!--                        <div class="form-group">
                            ...
                            <input type="hidden" id="hiddId" value="<?php echo $model->timeslot_id ?>" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7 col" style="padding-left: 0;">
                                <?php echo $form->textField($model, 'startDate', array('class' => 'form-control bookdatepicker startDate')); ?>
                            </div>
                            <div class="col-sm-5 col">
                                <?php echo $form->textField($model, 'startTime_show', array('class' => 'form-control booktimepicker startTime')); ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="clearfix"></div>
                            <div class="col-sm-7 col" style="padding-left: 0;">
                                <?php echo $form->textField($model, 'endDate', array('class' => 'form-control bookdatepicker endDate')); ?>
                            </div>
                            <div class="col-sm-5 col">
                                <?php echo $form->textField($model, 'endTime_show', array('class' => 'form-control booktimepicker endTime')); ?>
