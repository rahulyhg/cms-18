...
$this->title = Yii::t('static', 'Deleting Clinic {name}', array('{name}'=>$model->name));
?>
...
<div class="form-type">
    ...
    <div class="row">
        <div class="col-lg-5">
            ...
            <p><?php echo Yii::t('static', 'Deleting a clinic will remove all related data, e.g. calendar, events, appointments, etc...')?></p>
