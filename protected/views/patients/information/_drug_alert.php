...
<div class="panel panel-default">
    <div class="panel-heading">
        ...
        <?php echo CHtml::link(Yii::t('static', '<span class="glyphicon glyphicon-print"></span> Print'), array('mpdfprint/index', 'patient_id'=>$patient_id, 'type' => 'drugalert'), array('class' => 'btn-1 pull-right', 'target'=>'_blank')); ?>
        ...
        <?php echo CHtml::link(Yii::t('static', '<span class="glyphicon glyphicon-plus"></span>  Add'), array('patientsdrugalert/create', 'patient_id'=>$patient_id), array('class' => 'btn-1 pull-right')); ?>
    </div>
        ...
        <div class="form">
          ...
          $columnArray = array_merge($columnArray, array(
            ...
            array(
              'name' => 'comment',
              'type' => 'html',
              'value' => '$data->delete_date != "" ? nl2br($data->comment) . "(Entry deleted)": nl2br($data->comment)',
              'htmlOptions' => array('style' => 'text-align:left;')
              ),
            ));
