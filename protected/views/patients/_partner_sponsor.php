                    ...
                    <div class="col-md-12 form-group form-group-sm">
                        ...
                        <div class="col-md-9">
                            <div class="row phonenumber">
                                ...
                                <div class="col-md-3">
                                    <?php echo $form->textField($model,'spouse_number',array('size'=>47,'maxlength'=>255, 'class' => 'form-control numeric-control')); ?>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 form-group form-group-sm">
                        ...
                        <div class="col-md-9">
                            <div class="row phonenumber">
                                ...
                                <div class="col-md-3">
                                    <?php echo $form->textField($model,'nok_number_1',array('size'=>47,'maxlength'=>255, 'class' => 'form-control numeric-control')); ?>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-4">
                ...
                <div class="row">
                    <div class="col-md-12 form-group form-group-sm">
                        ...
                        <div class="col-md-8">
                            <?php echo $form->textField($model,'singapore_contact_number',array('size'=>47,'maxlength'=>255, 'class' => 'numeric-control form-control')); ?>
                        </div>
                    </div>
