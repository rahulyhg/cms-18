        ...
        <div class="box-1">
            ...
            <div class="col-sm-12 col print-section">
                ...
                <?php } ?>
                                ...
                                <td align="center"><input type="checkbox" value="<?php echo $m->id; ?>" class="turn_up" <?php echo $checked; ?> /></td>
                                <td><?php echo $m->comments; ?></td>
                                <td align="center" class="noprint">
                                    <?php if (!$m->from_api) { ?>
                                        <a href="<?php echo Yii::app()->createAbsoluteUrl('appointment/site/update', array('id' => $m->id)); ?>"><img src="<?php echo Yii::app()->theme->baseUrl . '/img/btn/edit_button.png'; ?>" class="button"></a>
                                        <a href="<?php echo Yii::app()->createAbsoluteUrl('appointment/site/delete', array('id' => $m->id)); ?>"><img src="<?php echo Yii::app()->theme->baseUrl . '/img/btn/delete_button.png'; ?>" class="button"></a>
                            <?php } ?>
                                </td>
                            </tr>
            <?php } ?>
