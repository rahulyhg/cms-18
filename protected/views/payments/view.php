    ...
    <div class="box-1">
        <div class="title-box clearfix">
            <h2 class="title"><?php echo Yii::t('static', 'Payments - View') ?></h2>
             <?php echo CHtml::link(Yii::t('static', '<span class="glyphicon glyphicon-print"></span> Print'), array('payments/printPdf/id/'.$model->id), array('class' => 'btn-1 pull-right','target'=>'_blank')); ?>
             <?php echo CHtml::link(Yii::t('static', '<span class="glyphicon glyphicon-usd"></span> Make Payment'), array('payments/makePaid/id/'.$model->id), array('class' => 'btn-1 pull-right')); ?>
