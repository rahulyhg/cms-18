    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            ...
            <div class="form-group">
                ...
                <?php echo $form->dropDownList($model, 'nationality', CHtml::listData($nationalities, 'nationality', 'nationality'), array('class' => 'form-control', 'style' => 'width:200px')); ?>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <?php echo $form->dropDownList($model, 'religion', CHtml::listData($religions, 'id', 'value'), array('class' => 'form-control', 'style' => 'width:200px')); ?>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-4" style="padding-left:0">
                    <?php echo $form->dropDownList($model, 'language_id', CHtml::listData($languages, 'id', 'value'), array('class' => 'form-control')); ?>
                </div>
                <div class="col-md-4">
                    <?php echo $form->textField($model, 'language', array('class' => 'form-control', 'style' => 'width:200px', 'placeholder' => Yii::t('static', 'or type your language'))); ?>
                </div>
            </div>
        </div>
        <div class="col-lg-7">
                ...
                <div class="row check-wrap-1">
                    <div class="list-2 clearfix">
                        ...
                        <div class="col-lg-8 col-md-6">
                            <?php echo CHtml::radioButtonList('question[' . $q->id . ']', $answers[$q->id],
