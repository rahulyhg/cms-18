    ...
    <div class="col-md-12">
        <div class="box-1">
            <div class="title-box clearfix">
                ...
                <?php echo CHtml::link(Yii::t('static', '<span class="glyphicon glyphicon-plus"></span> Add Appointment'), array('/appointments/addAppointment'), array('class' => 'btn-1 pull-right')); ?>
                        ...
                        <div class="modal-body form-type">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7 col">
                                        <?php echo $form->textField($modelSearch, 'startDate', array('class' => 'form-control datepicker startDate', 'readonly' => 'true')); ?>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7 col">
                                        <?php echo $form->textField($modelSearch, 'endDate', array('class' => 'form-control datepicker endDate', 'readonly' => 'true')); ?>
                                        <div class="errorMessage" id="endDateError"></div>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-7 col">
                                        <?php echo CHtml::button(Yii::t('static', 'Find'), array('class' => 'btn btn-primary', 'id' => 'searchapp')); ?>
                                    </div>
                                </div>
                            </div>
                            <?php $this->endWidget(); ?>
            ...
            <div class="col-sm-12 col print-section">
                <h4>Appointment List of <?php echo Yii::app()->params['doctorName']; ?></h4>
                <h4>Date: <?php echo $searchDate; ?></h4>
                <h4>Print Time: <?php echo date('d/m/Y h:i A'); ?></h4>
                        ...
                        foreach ($model as $m) {
                            ...
                            <tr>
                                ...
                                <td align="center" class="noprint">
                                    <?php if (!$m->from_api) { ?>
                                        <a class="btn-sm btn-default" href="<?php echo Yii::app()->createAbsoluteUrl('appointments/update', array('id' => $m->id)); ?>">
            ...
            <div class="clearfix"></div>
            <input type="hidden" id="ajaxTurnUpAppointment" value="<?php echo Yii::app()->createAbsoluteUrl('ajax/turnUpAppointment/'); ?>" />
            ...
            <div class="modal-body">
                <div class="form-type">
                    ...
                    $form = $this->beginWidget('CActiveForm', array(
                        ...
                        'enableAjaxValidation' => true,
                        'action' => Yii::app()->createUrl('/appointments/delete'),
                    ));
                    ?>
                    <div class="row">
                        ...
                        <div class="clearfix"></div>
                        <div class="form-group">
                            <?php echo CHtml::submitButton(Yii::t('static', 'Delete'), array('class' => 'btn btn-primary', 'id' => 'searchapp')); ?>
    ...
    $(function () {
        $('.printAppointment').click(function (event) {
            $(".print-section").print({
                ...
                title: "Appointment List of <?php echo Yii::app()->params['doctorName']; ?>",
            });
        });
        ...
        $('#searchapp').click(function(){
            var startTime = $('#Appointment_startDate').val();
            var endTime = $('#Appointment_endDate').val();
            if (startTime != '' && endTime != '')
            {
                startTime = startTime.split('-');
                endTime = endTime.split('-');
                var tempStart = new Date(startTime[2], startTime[1], startTime[0]).getTime();
                var tempEnd = new Date(endTime[2], endTime[1], endTime[0]).getTime();
                if (tempStart > tempEnd)
                {
                    $('#endDateError').html('End date cannot smaller than start date');
                }
                else
...
//        $('#Appointment_startDate').on('change', function(){
//            alert('to here');
//            $('#endDateError').html('');
//        })
//        $('#Appointment_endDate').on('change', function(){
//            alert('to here');
//            $('#endDateError').html('');
//        })
//        
        ...
        $('.turn_up').click(function () {
            ...
            .done(function (retData) {
                ...
                {
                    location.href = '<?php echo Yii::app()->createAbsoluteUrl('queues/queue'); ?>';
                }
            })
        });
