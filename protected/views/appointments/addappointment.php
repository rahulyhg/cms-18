...
$this->title = Yii::t('static', 'Add appointment');
?>
<div class="row">
    <div class="col-md-12">
        <div class="box-1">
            <div class="title-box clearfix">
                <h2 class="title"><?php echo Yii::t('static', 'Add Appointment') ?></h2>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7 col" style="padding-left: 0;">
                                <?php echo $form->textField($model, 'startDate', array('class' => 'form-control bookdatepicker startDate', 'readonly' => 'true', 'required' => 'required')); ?>
                            </div>
                            <div class="col-sm-5 col">
                                <?php echo $form->textField($model, 'startTime_show', array('class' => 'form-control booktimepicker startTime_show', 'readonly' => 'true', 'required' => 'required')); ?>
                                <?php echo $form->hiddenField($model, 'startTime', array('class' => 'form-control startTime')); ?>
                            </div>
                            <div class="clearfix"></div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="clearfix"></div>
                            <div class="col-sm-7 col" style="padding-left: 0;">
                                <?php echo $form->textField($model, 'endDate', array('class' => 'form-control bookdatepicker endDate', 'readonly' => 'true', 'required' => 'required')); ?>
                            </div>
                            <div class="col-sm-5 col">
                                <?php echo $form->textField($model, 'endTime_show', array('class' => 'form-control booktimepicker endTime_show', 'readonly' => 'true', 'required' => 'required')); ?>
                                <?php echo $form->hiddenField($model, 'endTime', array('class' => 'form-control endTime')); ?>
                            </div>
                            <div class="clearfix"></div>
                        </div>
                        <div class="clearfix"></div>
...
<input type="hidden" id="ajaxCheckBlackoutDate" value="<?php echo Yii::app()->createUrl('appointment/ajax/checkBlackoutDate/'); ?>" />
<input type="hidden" id="ajaxCheckNotWorkingDate" value="<?php echo Yii::app()->createUrl('appointment/ajax/checkNotWorkingDate/'); ?>" />
<input type="hidden" id="ajaxCheckExistTime" value="<?php echo Yii::app()->createUrl('appointment/ajax/checkExistTime/'); ?>" />
