...
<div class="box-1 add-new-patient add-new">
    <div class="title-box clearfix">
        ...
        <?php echo CHtml::link(Yii::t('static', '<span class="glyphicon glyphicon-ban-circle"></span> Cancel and Back'), array('/patients/healthynotes', 'patient_id' => $patient_id, 'healthytype' => 'glucose'), array('class' => 'btn-1 pull-right')); ?>
