...
<div class="box-1">
    <div class="title-box clearfix">
        <h2 class="title"><?php echo Yii::t('static', 'Search Patient and add to queue') ?></h2>
    ...
    <div class="box-body">
        ...
        $this->widget('zii.widgets.grid.CGridView', array(
          ...
          'emptyText' => 'No results found<br />
                        New patient : <a href="' . Yii::app()->createAbsoluteUrl("/patients/create??add_queue=yes") . '">Click here</a> to Add New Patient',
          'pager'=>array(
            'header'         => '',
            'prevPageLabel'  => 'Prev',
