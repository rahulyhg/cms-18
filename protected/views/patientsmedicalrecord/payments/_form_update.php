                        ...
                        ?>
                            <tr class='clickable-row invoice-item' >
                                ...
                                <td >
                                    ...
                                    <?php echo $form->textField($item, '[' . $index . ']item_name', array('class' => 'form-control item_name')) ?>
                                    <?php echo $form->error($item, 'item_name'); ?>
                                </td >


                                <td>
                                    <?php echo $form->numberField($item, '[' . $index . ']price', array('class' => 'form-control price')) ?>
                                    <?php echo $form->error($item, 'price'); ?>
                                </td>
                                <td>
                                    <?php echo $form->numberField($item, '[' . $index . ']quantity', array('class' => 'form-control quantity')) ?>
                                ...
                                <td>
                                    <?php echo $form->numberField($item, '[' . $index . ']discount', array('class' => 'form-control discount')) ?>
                                ...
                                <td>     <?php echo $form->textField($item, '[' . $index . ']total', array('class' => 'form-control total', 'readOnly' => true)) ?> </td>
