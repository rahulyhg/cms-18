...
<html>
    ...
    <body>
        ...
        $tableHeader = '<tr>
                            ...
                            <th id="drug-alert-grid_c1">Height (cm)</th>
                            <th id="drug-alert-grid_c1">Weight (kg)</th>
                        </tr>';
        ?>
        ...
        <div style="display: block;">      
            <table width="100%" border="0" align="center">
                ...
                foreach ($dataProvider as $item) {
                    ...
                    echo "<td style='text-align:left;'>".$item->height."</td>";
                    echo "<td style='text-align:left;'>".$item->weight."</td>";
                    echo "</tr>";  
