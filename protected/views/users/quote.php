<div class="global-form">
	<div class="col-md-12">
		...
		?>
			<div class="col-sm-5">
			<div class='row'>
				<?php echo $form->labelEx($model, 'company_name', array('class' => 'col-sm-4 control-label')); ?>
				<div class="col-sm-8">
			...
			<div class='row'>
				<?php echo $form->labelEx($model, 'contact_name', array('class' => 'col-sm-4 control-label')); ?>
				<div class="col-sm-8">
			...
			<div class='row'>
				<?php echo $form->labelEx($model, 'street_name', array('class' => 'col-sm-4 control-label')); ?>
				<div class="col-sm-8">
			...
			<div class='row'>
				<?php echo $form->labelEx($model, 'country', array('class' => 'col-sm-4 control-label')); ?>
				<div class="col-sm-8">
					<?php echo $form->dropDownList($model, 'country', AreaCode::loadAreaNameOnly(), array('empty' => '--Select One--', 'class' => 'form-control')); ?>
		...
		<div class="col-sm-6">
			...
			<div class='row'>
				...
				<div class="col-sm-8">
					<?php echo $form->textField($model, 'enquiry_date', array('class' => 'form-control my-datepicker-control', 'maxlength' => 255, 'readonly' => 'true')); ?>
		...
		<div class="col-md-12">
			<div class='row col-sm-4 threecol'>
		...
		<div class="col-md-12">
			...
			<div class='row col-sm-4 threecol'>
				<?php echo $form->labelEx($model, 'blue_print_attached', array('class' => 'control-label')); ?>
			...
			<div class='row col-sm-4 threecol'>
				<?php echo $form->labelEx($model, 'picture_attached', array('class' => 'control-label')); ?>
		...
		<div class="col-md-12">
			<div class='row threeco col-sm-12'>
				<?php echo $form->labelEx($model, 'note', array('class' => 'control-label')); ?>
				<div>
					<?php echo $form->textArea($model, 'note', array('style' => "width: 90%", 'rows' => 5)); ?>
					<?php echo $form->error($model, 'note'); ?>
				</div>
			</div>
		</div>

		<div class="row buttons" style="padding-right: 110px">
			<button type="submit" class="btn">Submit <span class="glyphicon glyphicon-send"></span></button>
		</div>
		<?php $this->endWidget(); ?>
	</div>
