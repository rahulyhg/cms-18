                ...
                <div class="row">
                    <div class="col-md-5 col-md-12">
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-sm-8">
                                <?php echo $form->dropDownList($model, 'alpha_from', ExportForm::$alphabet, array('class' => 'form-control','options' => array('a'=>array('selected'=>true)))) ?>
                        ...
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-sm-8">
                                <?php echo $form->dropDownList($model, 'alpha_to', ExportForm::$alphabet, array('class' => 'form-control','options' => array('z'=>array('selected'=>true)))) ?>
