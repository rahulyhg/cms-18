    ...
    <div class="box-1">
        ...
        $form = $this->beginWidget('CActiveForm', array(
            ...
            <div class="title-box clearfix">
                <h2 class="title"><?php echo Yii::t('static', 'Export Patient List - By visit date from to') ?></h2>
                ...
                <div class="row">
                    <div class="col-md-5 col-md-12">
                        <div class="form-group form-group-sm">
                            <?php echo $form->labelEx($model, 'from_date', array('class' => 'col-sm-4')); ?>
                            <div class="col-sm-8">
                                <?php                    
                                    echo $form->textField($model,'from_date',
                                        array(
                                            'size'=>47,
                                            'maxlength'=>255, 
                        ...
                        <div class="form-group form-group-sm">
                            <?php echo $form->labelEx($model, 'to_date', array('class' => 'col-sm-4')); ?>
                            <div class="col-sm-8">
                                <?php                    
                                    echo $form->textField($model,'to_date',
                                        array(
                                            'size'=>47,
                                            'maxlength'=>255, 
                                            'class' => 'form-control my-dob-datepicker'
