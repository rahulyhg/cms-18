                                ...
                                <table class="table table-hover table-responsive table-bordered" data-example-id="hoverable-table" >
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width: 30%">Pay model</th>
                                            <th style="width: 20%">Amount Pay</th>
                                    ...
                                    <tbody class="invoice-main">
                                            <tr class='clickable-row invoice-item' >
                                                <td >1</td>
                                                <td >
                                                    <?php echo $Amount->no_receipt; ?>
                                                </td >
                                                <td >
                                                    <?php echo $Amount->getType(); ?>
                                                </td >
                                                <td >
                                                    <?php echo Yii::app()->format->prices($Amount->amount_pay); ?>
                                                </td >
                                                <td >
                                                    <?php echo date('Y/m/d',$Amount->created); ?>
                                                </td >
                                            </tr>
                                    </tbody>
                    ...
                    <div class="form bottom-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5 ">
                                ...
                                <p> Discount:  <?php echo $model->discount . ' %'; ?></p>
