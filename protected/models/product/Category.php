<?php
class Category extends _BaseCategory
{
	public $categoryType = 'product';
	...
	public function relations() {
		...
		// class name for the relations automatically generated below.
			return array(
				...
				'childs' => array(self::HAS_MANY, 'Category', 'parent_id',  'order'=>'category_name ASC'),
	...
	/**
	* Jason
	* To get all active products category
	*/
    public static function findActiveCategory(){
        $model = self::model()->findAll(array('condition'=>'status = 1','order'=>'display_order'));
        return $model;
    }	
