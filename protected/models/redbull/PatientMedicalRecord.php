...
/**
 * This is the model class for table "{{_patient_medical_record}}".
 *
 * The followings are the available columns in table '{{_patient_medical_record}}':
 * @property integer $id
 ...
 */
class PatientMedicalRecord extends _BaseModel {
	...
	{
		return '{{_patient_medical_record}}';
	}
	 ...
	 * @return PatientMedicalRecord the static model class
	 */
	...
	{
		return PatientMedicalRecord::model()->count() + 1;
	}
